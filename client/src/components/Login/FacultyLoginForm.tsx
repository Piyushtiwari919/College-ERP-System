...
const FacultyLoginForm: React.FC<FacultyLoginFormProps> = ({ loginData, onChange, onSubmit, errors }) => {
  return (
    <div className="absolute bg-gray-800 p-8 rounded-xl shadow-lg w-full max-w-md">
      <h1 className="text-3xl font-bold text-center mb-6 text-white">FACULTY Login</h1>
