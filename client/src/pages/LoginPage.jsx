...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen w-full relative overflow-y-hidden">
      {/* Background Image */}
      ...
      {/* Title */}
      <h2 className="absolute text-8xl text-orange-500 top-6 font-bold">
         ERP Portal
      </h2>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {role === "student" && (
            <div className="flex flex-col space-y-1">
              ...
              />
              {errors.admissionNo && (
                <span className="text-red-400 text-sm">{errors.admissionNo}</span>
              )}
            </div>
          )}
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            {/* Only for Students → New Registration */}
            {role === "student" && (
              <button
                type="button"
